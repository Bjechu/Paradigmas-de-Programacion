...
class Computadora:
	...
	def __init__(self, marca:str, capacidad:int, ram:int):
		print(f"Accediendo al contructor de la pc: {marca}")
		self.marca = marca
		self.capacidad = capacidad
		self.ram = ram

	def imprimirInfoPC(self):
		print(f"Esta es la computadora marca: {self.marca} con almacenamiento se {self.capacidad}GB y memoria de {self.ram}GB")
